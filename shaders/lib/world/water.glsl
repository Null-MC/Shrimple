const float WaterAmbientF = 0.1;
const float WaterDensityF = 1.0 * WorldWaterDensityF;
const vec3 WaterScatterF = _RGBToLinear(WaterScatterColor);
const vec3 WaterAbsorbF = _RGBToLinear(1.0 - WaterAbsorbColor);
