#define BLOCK_OUTLINE_DEFAULT 0
#define BLOCK_OUTLINE_WHITE 1
#define BLOCK_OUTLINE_FANCY 2

#define BLOCK_OUTLINE_COLOR 0
#define BLOCK_OUTLINE_CONSTRUCTION 1
