...
#define DEBUG_VIEW_BLOCKLIGHT 6
...
#define BLOCKTYPE_BELL_FLOOR_N_S 4u
#define BLOCKTYPE_BELL_FLOOR_W_E 5u
#define BLOCKTYPE_CACTUS 6u
#define BLOCKTYPE_CAKE 7u
#define BLOCKTYPE_CAMPFIRE_N_S 8u
#define BLOCKTYPE_CAMPFIRE_W_E 9u
#define BLOCKTYPE_COMPARATOR 10u
#define BLOCKTYPE_CANDLE_CAKE 11u
#define BLOCKTYPE_CARPET 12u
#define BLOCKTYPE_DAYLIGHT_DETECTOR 13u
#define BLOCKTYPE_ENCHANTING_TABLE 14u
#define BLOCKTYPE_END_PORTAL_FRAME 15u
#define BLOCKTYPE_FLOWER_POT 16u
#define BLOCKTYPE_GRINDSTONE_FLOOR_N_S 17u
#define BLOCKTYPE_GRINDSTONE_FLOOR_W_E 18u
#define BLOCKTYPE_GRINDSTONE_WALL_N_S 19u
#define BLOCKTYPE_GRINDSTONE_WALL_W_E 20u
#define BLOCKTYPE_HOPPER_DOWN 21u
#define BLOCKTYPE_HOPPER_N 22u
#define BLOCKTYPE_HOPPER_E 23u
#define BLOCKTYPE_HOPPER_S 24u
#define BLOCKTYPE_HOPPER_W 25u
#define BLOCKTYPE_LECTERN 26u
#define BLOCKTYPE_LIGHTNING_ROD_N 27u
#define BLOCKTYPE_LIGHTNING_ROD_E 28u
#define BLOCKTYPE_LIGHTNING_ROD_S 29u
#define BLOCKTYPE_LIGHTNING_ROD_W 30u
#define BLOCKTYPE_LIGHTNING_ROD_UP 31u
#define BLOCKTYPE_LIGHTNING_ROD_DOWN 32u
#define BLOCKTYPE_PATHWAY 33u
#define BLOCKTYPE_PISTON_EXTENDED_N 34u
#define BLOCKTYPE_PISTON_EXTENDED_E 35u
#define BLOCKTYPE_PISTON_EXTENDED_S 36u
#define BLOCKTYPE_PISTON_EXTENDED_W 37u
#define BLOCKTYPE_PISTON_EXTENDED_UP 38u
#define BLOCKTYPE_PISTON_EXTENDED_DOWN 39u
#define BLOCKTYPE_PISTON_HEAD_N 40u
#define BLOCKTYPE_PISTON_HEAD_E 41u
#define BLOCKTYPE_PISTON_HEAD_S 42u
#define BLOCKTYPE_PISTON_HEAD_W 43u
#define BLOCKTYPE_PISTON_HEAD_UP 44u
#define BLOCKTYPE_PISTON_HEAD_DOWN 45u
#define BLOCKTYPE_PRESSURE_PLATE 46u
#define BLOCKTYPE_REPEATER 47u
#define BLOCKTYPE_STONECUTTER 48u
