...
//const vec3 CloudScatterColor_clear = _RGBToLinear(vec3(0.44));
//const vec3 CloudAbsorbColor_clear = _RGBToLinear(1.0 - vec3(0.24));
//
...
#define CLOUD_REFLECT_SHADOW_STEPS 4
    ...
    const float CloudPlaneHeight = 40.0;//SKY_CLOUD_HEIGHT;
...
#else
    const float CloudPlaneHeight = 4.0;
