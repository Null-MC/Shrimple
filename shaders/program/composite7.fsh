...
layout(location = 0) out vec4 outFinal;
    ...
    void main() {
        ...
        //         reflectDir = mat3(gbufferModelView) * reflectDir;
        //         vec4 reflection = GetReflectColor(depthtex1, viewPos, reflectDir, 0);
        //         final.rgb = mix(final.rgb, reflection.rgb, reflection.a);
        //     }
        // #endif
