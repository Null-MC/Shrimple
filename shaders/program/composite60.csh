...
//        ivec2 txs = uv_in; //texcoord * RENDER_SCALE_F;
//        vec3 in0 = texelFetch(TEX_FINAL, txs, 0).rgb;
//        vec3 in1 = texelFetchOffset(TEX_FINAL, txs, 0, ivec2(+1,  0)).rgb;
//        vec3 in2 = texelFetchOffset(TEX_FINAL, txs, 0, ivec2(-1,  0)).rgb;
//        vec3 in3 = texelFetchOffset(TEX_FINAL, txs, 0, ivec2( 0, +1)).rgb;
//        vec3 in4 = texelFetchOffset(TEX_FINAL, txs, 0, ivec2( 0, -1)).rgb;
//        vec3 in5 = texelFetchOffset(TEX_FINAL, txs, 0, ivec2(+1, +1)).rgb;
//        vec3 in6 = texelFetchOffset(TEX_FINAL, txs, 0, ivec2(-1, +1)).rgb;
//        vec3 in7 = texelFetchOffset(TEX_FINAL, txs, 0, ivec2(+1, -1)).rgb;
//        vec3 in8 = texelFetchOffset(TEX_FINAL, txs, 0, ivec2(-1, -1)).rgb;
