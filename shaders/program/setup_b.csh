...
void main() {
        ...
        switch (blockId) {
            ...
            case BLOCK_ANVIL_N_S:
                shapeCount = 3u;
                boundsMin[0] = vec3(( 3.0/16.0), (10.0/16.0), 0.0);
                boundsMax[0] = vec3((13.0/16.0),         1.0, 1.0);
                boundsMin[1] = vec3(( 6.0/16.0), 0.25, 0.25);
                boundsMax[1] = vec3((10.0/16.0), 0.75, 0.75);
                boundsMin[2] = vec3(( 2.0/16.0), 0.00, ( 2.0/16.0));
                boundsMax[2] = vec3((14.0/16.0), 0.25, (14.0/16.0));
                break;

            case BLOCK_ANVIL_W_E:
                shapeCount = 3u;
                boundsMin[0] = vec3(0.0, (10.0/16.0), ( 3.0/16.0));
                boundsMax[0] = vec3(1.0,         1.0, (13.0/16.0));
                boundsMin[1] = vec3(0.25, 0.25, ( 6.0/16.0));
                boundsMax[1] = vec3(0.75, 0.75, (10.0/16.0));
                boundsMin[2] = vec3(( 2.0/16.0), 0.00, ( 2.0/16.0));
                boundsMax[2] = vec3((14.0/16.0), 0.25, (14.0/16.0));
                break;
